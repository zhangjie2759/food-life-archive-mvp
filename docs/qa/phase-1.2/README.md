...
The automated mobile suite separately covers 390 × 844 Chromium and 360 × 800 WebKit, including horizontal-overflow and 44 px touch-target checks. Real Safari camera permission, pinch gestures, system sharing, and PWA installation remain device-level acceptance items.
